...
> Última actualización: v3.5.14 (OSINT reliability — 4 validaciones cruzadas independientes corrigieron: margen oscila 859-1.303 votos intra-día, recursos JP confirmados públicamente = 2 (no 4) por ~2.398 mesas, presidencia interina = Balcázar (Boluarte destituida 2025), JNE presidido por Burneo (no Salas Arenas), concentración pro-Fujimori 14-jun Javier Prado marcada DUDOSA, marcha Arequipa Gen Z parte de Plaza España, Cerrón prófugo, canales Karamba eliminados de YouTube).
